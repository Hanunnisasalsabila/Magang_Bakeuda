...
export function mapPrismaObjekToOracle(prismaData: {
  ...
  return {
    ...
    RW_OP: prismaData.rw_op ?? null,
    RT_OP: prismaData.rt_op ?? null,
    TOTAL_LUAS_BUMI: prismaData.luas_tanah,
    TOTAL_LUAS_BNG: prismaData.luas_bangunan,
    NJOP_BUMI: prismaData.njop_tanah ?? 0,
    NJOP_BNG: prismaData.njop_bangunan ?? 0,
    NIP_PENDATA: prismaData.nip_pendata ?? null,
    NIP_PEMERIKSA_OP: prismaData.nip_pemeriksa ?? null,
  };
}
