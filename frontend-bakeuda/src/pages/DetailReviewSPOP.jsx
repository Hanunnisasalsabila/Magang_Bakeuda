          ...
          <section className="border border-gray-300">
            <div className="bg-blue-50 border-b border-blue-200 px-4 py-2">
              <h3 className="text-base font-bold text-blue-900 uppercase m-0">
                {data.jenis_transaksi !== 'BARU' ? 'A. DATA NOP ASAL (INDUK)' : 'A. NOMOR OBJEK PAJAK (NOP)'}
              </h3>
            </div>
            <div className="p-0">
                ...
                <tbody>
                  <tr>
                    <td className="p-3 w-1/4 bg-gray-50 font-semibold text-gray-700">
                      {data.jenis_transaksi !== 'BARU' ? 'Nomor Objek Pajak Induk' : 'Nomor Objek Pajak'}
                    </td>
                    <td className="p-3 font-mono font-bold text-black tracking-widest border-r border-gray-200">
                      {data.jenis_transaksi !== 'BARU' ? (nopAsal !== 'Menunggu NOP' ? nopAsal : <span className="text-gray-400 font-mono tracking-widest">............-.......</span>) : (detailTujuanList[0]?.nop_generated || 'Akan digenerate oleh Bakeuda')}
                    </td>
                    ...
                    {data.jenis_transaksi === 'BARU' && (
                      <>
                        <td className="p-3 w-1/4 bg-gray-50 font-semibold text-gray-700"></td>
                        <td className="p-3 font-bold text-black"></td>
                      </>
                    )}
                  </tr>
